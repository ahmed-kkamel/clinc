...
export default function Home({ params: { locale } }) {
  ...
  return (
    <main className="container flex flex-col pb-[180px]">
      <h1 className="text-[64px] leading-[120px] text-[#000C1D]">
        الخدمات العلاجيه
      </h1>
      <p className="mb-[48px] max-w-[700px] text-xl font-medium text-[#23536A] ">
      ...
      <LongPressSlider />
      <h2 className="mt-[80px] text-[64px] font-medium leading-[120px] text-[#000C1D]">
        خدامات الحجز
      </h2>
      <CardGrid />
    </main>
